...
<?php $form = $this->beginWidget('CActiveForm', array(
	...
	<div class="control-group label_management">
		...
		<?php echo CHtml::label('名前', '', array('class'=>'control-label')); ?>
		...
		<?php echo CHtml::label('フリガナ', '', array('class'=>'control-label')); ?>
		<div class="controls controls-row">
		...
		<div class="center-actions">
			<button type="submit" class="btn btn-success span2 close-btn" data-dismiss="modal">戻る</button>
			<button type="button" name="button" value="delete" class="btn btn-danger span2">削除</button>
			<button type="button" name="button" value="update" class="btn btn-primary span2">更新</button>
		</div>
	</div>
<?php $this->endWidget(); ?>
</div>