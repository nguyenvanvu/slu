...
<div id="user-nav" class="navbar navbar-inverse">
	<ul class="nav">
		<li class="" ><a title="" href="#"><i class="icon icon-user"></i> <span class="text">ログアウト</span></a></li>
	</ul>
</div>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
	<ul>
		<li class="active submenu"><a href="<?php echo Yii::app()->createUrl('admin/student');?>"><span>受講者管理メニュー</span></a>
			<ul>
				<li><a href="<?php echo Yii::app()->createUrl('html/studentManagement');?>">受講者管理</a></li>
				<li><a href="<?php echo Yii::app()->createUrl('html/registeredSeminarList');?>">受講予定者一覧</a></li>
			</ul>
		</li>
		<li class="submenu"><a href="<?php echo Yii::app()->createUrl('html/todaySeminarList');
			?>"><span>受付処理メニュー</span></a>
			<ul>
				<li><a href="<?php echo Yii::app()->createUrl('html/todaySeminarList');
			?>">受講者受付処理</a></li>
			</ul>
		</li>
		<li class="submenu"><a href="<?php echo Yii::app()->createUrl('html/finishedSeminarList');?>"><span>受講状況管理</span></a>
			<ul>
				<li><a href="<?php echo Yii::app()->createUrl('html/finishedSeminarList');?>">セミナー別受講者一覧</a></li>
				<li><a href="<?php echo Yii::app()->createUrl('html/statusStudentList'); ?>">受講者管理</a></li>
				<li><a href="#">アーカイブ閲覧管理</a></li>
			</ul>
		</li>
		<li><a href="<?php echo Yii::app()->createUrl('html/seminarManagement');?>"><span>セミナー管理</span></a></li>
		<li class="submenu"><a href="<?php echo Yii::app()->createUrl('html/attendedStudent');?>"><span>認定者管理メニュー</span></a>
			<ul>
				<li><a href="<?php echo Yii::app()->createUrl('html/attendedStudent');?>">認定者管理</a></li>
				<li><a href="#">認定結果一覧</a></li>
				<li><a href="<?php echo Yii::app()->createUrl('html/testList');?>">更新試験管理</a></li>
				<li><a href="<?php echo Yii::app()->createUrl('html/questionList');?>">更新問題管理</a></li>
			</ul>
		</li>
		<li><a href="<?php echo Yii::app()->createUrl('html/import');?>"><span>合格者情報取り込み</span></a></li>
	</ul>
</div>
<div id="content">
